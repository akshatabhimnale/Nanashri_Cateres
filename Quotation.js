...
const NanashriCaterersForm = ({ route }) => {
  ...
  const generatePDF = async () => {
      ...
      <html>
        ...
        <body>
            ...
            <tr style="display:flex; flex-direction:row; ">
              ...
              <td colspan="1" style="width:278px; border-right:none; border-top:none; border-bottom:none">
                <p style="font-size: 18px;"><strong>Date:</strong> ${formattedDate}</p>
          ...
          <table style="height:100%; width:758px; margin-top:-1px;margin-right:-7px;border-right:none">
            <thead>
              <tr>
                ...
                <th style="text-align: center;  font-size: 18px; ">Item Name</th>
              </tr>
            </thead>
            <tbody style="justify-content: center;">
              ${form.menuItems
                ...
                <tr style="width:100%">
                  ...
                  <td style="border: none;line-height:2px; text-align: center; font-size: 18px;">${
                    item.itemName
                  }</td>    
                </tr>`
                )
          ...
          <table style="width:100%; margin-top:-1px; margin-left:0px;">
                <thead>
                    <tr>
                        <th style="text-align: center; font-size: 18px">Rate</th>
                        <th style="text-align: center; font-size: 18px; width:30%;margin-left:-20px">Quantity</th>
                ...
                <tbody>
                    ...
                    <td style="text-align: center; font-size: 18px; border-left:none;margin-left:10px;">${
                      form.totalAmount / form.quantityOfPeople
                    }</td>
                        <td style="text-align: center; font-size: 18px; border-left:none;margin-left:10px;">${
    ...
    try {
      // const {uriImg} = await captureRef(webViewRef, {
      //   format: "jpg",
      //   quality: 1,
      // });
      // setImageUri(uriImg);
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.webViewContainer} ref={webViewRef}>
        ...
        <body>
            ...
            <tr style="display:flex; flex-direction:row;">
              <td colspan="1" style="width:436px; font-size: 18px;"><p><strong>Name:</strong> ${
                form.name
              }</p>
                <p style="font-size: 18px;"><strong>Address:</strong> ${
                  form.address
              ...
              <td colspan="1" style="width:445px;">
                <p style="font-size: 18px;"><strong>Date:</strong> ${formattedDate}</p>
                <p style="font-size: 18px;"><strong>Time:</strong> ${formattedTime}</p>
              </td>
            </tr>
      ...
      {imageUri && <Image source={{ uriImg: imageUri }} style={styles.image} />}
